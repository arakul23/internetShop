...
<select class="form-control input-sm" name="productId" required>
            ...
            <input type = "date" id = "dateFinish" name = "dateFinish"><br>

               <input type="submit" value="Добавить" id="addDiscount" class="btn btn-primary" style = "margin:20px 0px">
            {{ csrf_field() }}
</form>
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <input type="hidden" id = "idProduct" value = "{{$disc->id_product}}">
                </tr>
@endforeach
              </table>
            </div>
