...
<head>
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="../resources/views/admin/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
  <!-- Theme style -->
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <input type="submit" value="Добавить характеристику" class="btn btn-primary" style="margin-top:20px">
