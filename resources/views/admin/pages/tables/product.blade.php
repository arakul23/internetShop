            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box">
                        ...
                        <form action={{url('/addProd')}} method="post" class="col-lg-4" id="formProduct"
                            ...
                            <input name="prodPrice" id="prodPrice" class="form-control input-sm" pattern="^[ 0-9]+$"
                                   required><br>
                                ...
                                <div style="overflow: auto;">
                                    ...
                                    <table>
                                        @foreach($properties as $prop)
                                            <tr>
                                                <td><input type='checkbox' name="propertyName[]"
                                                           value="{{$prop->id}}"><label>{{$prop->name}}</label><input
                                                            name="{{$prop->id}}"></td>
                                            </tr>
                                        @endforeach
                                    </table>
                        ...
                        <div id="editProduct" style="display: none">
                            <form action={{url('/editProd')}} method="post" class="col-lg-4 col-md-offset-2"
                                ...
                                <label for="prodPrice">Стоимость товара</label><br>
                                <input name="prodPriceEdit" id="prodPriceEdit" class="form-control input-sm"
                                ...
                                <label for="descriptionProd">Описание товара</label><br>
                                <textarea class="form-control" id="descriptionProdEdit"
                                          name="descriptionProdEdit"></textarea>
                                            ...
                                            <div class="form-row">
                                                <div class="col">
                                                    ...
                                                    <button type="submit" class="btn btn-primary" value="X"
                                                            onclick="showEditProductForm(this)">
                                                ...
                                                <div class="col">
                                                    <form action="{{url('/deleteProd')}}" method="post"
                                                          style="width:30px">
