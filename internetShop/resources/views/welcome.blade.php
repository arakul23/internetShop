        ...
        <div class="row">
            <div class="col-md-4">
                <div class="single-product-widget">
                    ...
                    <div class="single-wid-product">
                        <a href="single-product.blade.php"><img src="img/product-thumb-1.jpg" alt=""
                                                                class="product-thumb"></a>
                        <h2><a href="single-product.blade.php">Sony Smart TV - 2015</a></h2>
                    ...
                    <div class="single-wid-product">
                        <a href="single-product.blade.php"><img src="img/product-thumb-2.jpg" alt=""
                                                                class="product-thumb"></a>
                        <h2><a href="single-product.blade.php">Apple new mac book 2015</a></h2>
                        <div class="product-wid-rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                    ...
                    <div class="single-wid-product">
                        <a href="single-product.blade.php"><img src="img/product-thumb-3.jpg" alt=""
                                                                class="product-thumb"></a>
                        <h2><a href="single-product.blade.php">Apple new i phone 6</a></h2>
                        <div class="product-wid-rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-md-4">
                <div class="single-product-widget">
                    ...
                    <a href="#" class="wid-view-more">View All</a>
                    <div class="single-wid-product">
                        <a href="single-product.blade.php"><img src="img/product-thumb-4.jpg" alt=""
                                                                class="product-thumb"></a>
                        <h2><a href="single-product.blade.php">Sony playstation microsoft</a></h2>
                        <div class="product-wid-rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                    ...
                    <div class="single-wid-product">
                        <a href="single-product.blade.php"><img src="img/product-thumb-1.jpg" alt=""
                                                                class="product-thumb"></a>
                        <h2><a href="single-product.blade.php">Sony Smart Air Condtion</a></h2>
                        <div class="product-wid-rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                    ...
                    <div class="single-wid-product">
                        <a href="single-product.blade.php"><img src="img/product-thumb-2.jpg" alt=""
                                                                class="product-thumb"></a>
                        <h2><a href="single-product.blade.php">Samsung gallaxy note 4</a></h2>
                        <div class="product-wid-rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
